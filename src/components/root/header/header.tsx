    ...
    return (
        <header className="navbar bg-base-300 p-4 header">
            ...
            <nav className="navbar-nav gap-2">
                ...
                {/* pre-login */}
                <Link href="/login" className="hidden xs:inline-flex btn btn-primary uppercase">Log in</Link>
                <Link href="/register" className="hidden sm:inline-flex btn uppercase">Register</Link>
                ...
                <div className="hidden md:inline-flex dropdown dropdown-end">
                    ...
                    <ul tabIndex={0} className="mt-16 p-2 shadow menu menu-compact dropdown-content bg-base-200 rounded-box w-52">
                        <li><a>Profile</a></li>
                        <li><ThemeSwitch className="self-stretch" /></li>
                        <li><a>Logout</a></li>
                    </ul>
                </div>
            </nav>
