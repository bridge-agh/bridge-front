  ...
  return (
    ...
    >
      ...
      <rect
        ...
        fill={background}
      ></rect>
      <use xlinkHref="#VC3" height="32" width="32" x="-100.4" y="-145.5"></use>
      <use
        xlinkHref="#SC3"
        height="26.769"
        width="26.769"
        ...
        y="-108.5"
      ></use>
      <use xlinkHref="#SC3" height="54" width="54" x="-27" y="-130.735"></use>
      <use xlinkHref="#SC3" height="54" width="54" x="-27" y="-27"></use>
