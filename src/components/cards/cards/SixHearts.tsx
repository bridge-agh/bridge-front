  ...
  return (
    ...
    >
      ...
      <rect
        ...
        fill={background}
      ></rect>
      <use xlinkHref="#VH6" height="32" width="32" x="-100.4" y="-145.5"></use>
      <use
        xlinkHref="#SH6"
        height="26.769"
        width="26.769"
      ...
      <use
        ...
        y="-130.667"
      ></use>
      <use xlinkHref="#SH6" height="54" width="54" x="-72.167" y="-27"></use>
      <use xlinkHref="#SH6" height="54" width="54" x="18.167" y="-27"></use>
