      ...
      <div className="flex flex-col border-opacity-50">
        <div className="h-auto card bg-base-200 rounded-box place-items-center p-6 gap-6">
          ...
          <div className="flex flex-col sm:flex-row w-full gap-4">
            <input className="input input-bordered input-primary sm:flex-1" placeholder="Game ID" />
            <Link href="/lobby" className="btn btn-primary">Join</Link>
          </div>
        </div>
        <div className="divider">OR</div>
        <div className="h-auto card bg-base-200 rounded-box place-items-center p-6 gap-6">
          <p className="text-3xl text-secondary-content text-center">Create your lobby</p>
          <Link href="/lobby" className="btn btn-primary">Create a game</Link>
        </div>
      </div>
    </div>
  )
